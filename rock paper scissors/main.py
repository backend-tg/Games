...
def RockCom():
    if player_option == 1:
        ...
        status_label.config(text="ИГРОК ВЫИГРАЛ!")
    elif player_option == 3:
        status_label.config(text="КОМПЬЮТЕР ВЫИГРАЛ!")
